...
**정리:** 인증(카카오·토큰) → 그룹/메인·이미지 → 커뮤니티·댓글 → 회계 쪽 순으로 밀었고, **커밋 메시지에 남긴 그대로** 수정/삭제·답글 UI·관리자·회계 일부는 마감 전까지 과제로 남았습니다. 포트폴리오에서는 “완벽한 완성”보다 **남은 문제를 기록해 둔 점**이 오히려 협업·일정 관리 맥락을 설명하기에 좋습니다.
...
아래는 실제 연동이 완료된 범위를 한눈에 정리한 것입니다. (이전 버전의 “주요 기능” 목록은 일부가 기획·목표 수준으로 읽힐 수 있어, 표와 모순되지 않게 수정했습니다.)
